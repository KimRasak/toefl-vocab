...
输出: site/listening/all/index.html, subjects.json（学科映射，供审计与复用）
"""
import json
import os
import re
...
OUT = os.path.join(REPO_ROOT, "site", "listening", "all", "index.html")
...
SEL_PLAYER = os.path.join(REPO_ROOT, "site", "listening", "selected", "index.html")
...
if os.path.exists(SEL_PLAYER):
    ...
    print("  !! 找不到精选页 site/listening/selected/index.html，进度迁移表留空")
