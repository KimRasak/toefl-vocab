...
输出: site/listening/selected/index.html（数据内嵌）
"""
import json
import os
import re
...
REPO_ROOT = os.path.dirname(os.path.dirname(os.path.dirname(BASE)))
DATA = os.path.join(BASE, "gh_player_data.json")
OUT = os.path.join(REPO_ROOT, "site", "listening", "selected", "index.html")
