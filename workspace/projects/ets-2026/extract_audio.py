#!/usr/bin/env python3
"""把 listening_2026.json 引用到的听力音频从各 zip 里抽出来，摊平到 site/listening/2026/audio/。
...
输出: ../../../site/listening/2026/audio/*.ogg|mp3 + audio_map.json
"""
import json
import os
import sys
...
OUTDIR = os.path.join(REPO_ROOT, "site", "listening", "2026", "audio")
OUTMAP = os.path.join(REPO_ROOT, "site", "listening", "2026", "audio_map.json")
