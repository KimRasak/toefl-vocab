...
数据来源：
  ...
  ../../../site/listening/2026/audio/     -> extract_audio.py 摊平出来的音频
  ../../../site/listening/2026/audio_map.json -> "zip::内部路径" -> 摊平文件名
...
输出: ../../../site/listening/2026/index.html
"""
import json
import os
import re
...
SITE = os.path.join(REPO_ROOT, "site", "listening", "2026")
