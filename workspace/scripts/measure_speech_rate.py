...
TPO_DIR = os.path.join(WORKSPACE, "projects", "tpo-listening")
NEW_JSON = os.path.join(WORKSPACE, "projects", "ets-2026", "listening_2026.json")
NEW_AUDIO = os.path.join(ROOT, "site", "listening", "2026", "audio")
NEW_MAP = os.path.join(ROOT, "site", "listening", "2026", "audio_map.json")
...
if __name__ == "__main__":
    ...
    json.dump({"new": new, "tpo": old}, open(os.path.join(ANALYSIS_DIR, "speech_rate_measured.json"), "w"),
              ensure_ascii=False, indent=1)
    print("\n明细已写入 workspace/data/analysis/speech_rate_measured.json")
