...
MEASURED = os.path.join(ANALYSIS_DIR, "speech_rate_measured.json")
NEW_AUDIO = os.path.join(ROOT, "site", "listening", "2026", "audio")
TPO_AUDIO = os.path.join(WORKSPACE, "projects", "tpo-listening", "audio")
FRAME_MS = 20
...
if __name__ == "__main__":
    ...
    json.dump({"new": new, "tpo_sample": old},
              open(os.path.join(ANALYSIS_DIR, "speech_rate_articulation.json"), "w"),
              ensure_ascii=False, indent=1)
    print("\n明细已写入 workspace/data/analysis/speech_rate_articulation.json")
