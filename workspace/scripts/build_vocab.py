...
VOCAB_DIR = os.path.join(ROOT, "data", "vocabulary")
SRC_DIR = os.path.join(ROOT, "projects", "tpo-listening", "transcripts")
DISC_FILE = "/tmp/tpo_discipline.json"
FREQ_FILE = "/tmp/tpo_discipline_freq.json"
OUT_JSON = "/tmp/tpo_final_vocab.json"
OUT_MD = os.path.join(VOCAB_DIR, "tpo_listening_vocab.md")
...
def load_existing():
    words = set()
    paths = [
        os.path.join(VOCAB_DIR, "quizlet-my-tofel-1675.tsv"),
        os.path.join(VOCAB_DIR, "quizlet-my-tofel-1925.tsv"),
        os.path.join(VOCAB_DIR, "tofel_words_1791.txt"),
    ]
    for p in paths:
